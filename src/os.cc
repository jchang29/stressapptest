...
#warning "Unsupported CPU type ARMV7A: unable to determine feature set."
  ...
  has_vector_ = true; // NEON.
#warning "Unsupported CPU id for AARCH64: unable to determine feature set. using NEON vector"
// TODO: For arm64-v8a there is no clflush, so consider to use instructions DBM, DSB, ISB, DC, IC
#else
